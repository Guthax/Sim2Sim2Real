...
from simulators.duckietown.wrappers import ResizeWrapper, CannyWrapper, CropWrapper
...
def train():
    ...
    env = DuckietownDirectVelocities(render_img=False)
    ...
    model_name = "duckie_direct_velocities"
