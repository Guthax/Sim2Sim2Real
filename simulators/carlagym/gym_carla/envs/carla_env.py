...
from simulators.carlagym.gym_carla.envs.render import BirdeyeRender
from simulators.carlagym.gym_carla.envs.route_planner import RoutePlanner
from simulators.carlagym.gym_carla.envs.misc import *
...
class CarlaEnv(gym.Env):
  ...
  def __init__(self):
    ...
    self.observation_space = spaces.Box(low=0, high=255, shape=(self.obs_size, self.obs_size, 3), dtype=np.uint8)
